...
impl<EP: EventPublisher + 'static> OutboxPublisher<EP> {
    ...
    pub async fn start(self) {
        info!("Starting outbox publisher with interval {:?}", self.poll_interval);
