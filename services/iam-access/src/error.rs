...
impl From<AccessError> for AppError {
    fn from(error: AccessError) -> Self {
        match error {
            ...
            AccessError::PermissionNotFound => AppError::NotFound("Permission not found".to_string()),
            ...
            AccessError::PermissionAlreadyExists => AppError::Conflict("Permission already exists".to_string()),
            AccessError::PolicyAlreadyExists => AppError::Conflict("Policy already exists".to_string()),
