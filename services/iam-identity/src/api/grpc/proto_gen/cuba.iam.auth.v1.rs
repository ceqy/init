...
pub mod auth_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cuba.iam.auth.v1.AuthService/Login" => {
                ...
                "/cuba.iam.auth.v1.AuthService/Logout" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/RefreshToken" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/ValidateToken" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/ChangePassword" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/RequestPasswordReset" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/ResetPassword" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/Enable2FA" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/Disable2FA" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/Verify2FA" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/GetActiveSessions" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/RevokeSession" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/StartWebAuthnRegistration" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/FinishWebAuthnRegistration" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/StartWebAuthnAuthentication" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/FinishWebAuthnAuthentication" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/ListWebAuthnCredentials" => {
                    #[allow(non_camel_case_types)]
                ...
                "/cuba.iam.auth.v1.AuthService/DeleteWebAuthnCredential" => {
                    #[allow(non_camel_case_types)]
    ...
    pub const SERVICE_NAME: &str = "cuba.iam.auth.v1.AuthService";
