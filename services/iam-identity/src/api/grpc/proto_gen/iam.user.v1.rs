...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/iam.user.v1.UserService/Register" => {
                ...
                "/iam.user.v1.UserService/GetCurrentUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/UpdateProfile" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/DeleteUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/ActivateUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/DeactivateUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/LockUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/UnlockUser" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/AssignRoles" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/RemoveRoles" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/GetUserRoles" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/SendEmailVerification" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/VerifyEmail" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/SendPhoneVerification" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.user.v1.UserService/VerifyPhone" => {
                    #[allow(non_camel_case_types)]
    ...
    pub const SERVICE_NAME: &str = "iam.user.v1.UserService";
