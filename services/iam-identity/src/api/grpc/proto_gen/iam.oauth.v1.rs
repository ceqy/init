...
pub mod o_auth_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/iam.oauth.v1.OAuthService/CreateClient" => {
                ...
                "/iam.oauth.v1.OAuthService/GetClient" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/UpdateClient" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/DeleteClient" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/ListClients" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/Authorize" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/Token" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/RefreshToken" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/RevokeToken" => {
                    #[allow(non_camel_case_types)]
                ...
                "/iam.oauth.v1.OAuthService/IntrospectToken" => {
                    #[allow(non_camel_case_types)]
    ...
    pub const SERVICE_NAME: &str = "iam.oauth.v1.OAuthService";
