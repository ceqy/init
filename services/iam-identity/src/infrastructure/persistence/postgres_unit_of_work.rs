...
use crate::domain::repositories::auth::{
    BackupCodeRepository, LoginLogRepository, PasswordResetRepository,
    SessionRepository, WebAuthnCredentialRepository,
};
...
use crate::domain::repositories::user::{
    EmailVerificationRepository, PhoneVerificationRepository, TenantRepository,
    UserRepository,
};
use crate::domain::unit_of_work::{UnitOfWork, UnitOfWorkFactory};

use super::tx_repositories::{
    TxUserRepository, TxTenantRepository, TxEmailVerificationRepository,
    TxPhoneVerificationRepository, TxSessionRepository, TxBackupCodeRepository,
    TxLoginLogRepository, TxPasswordResetRepository, TxWebAuthnCredentialRepository,
    TxOAuthClientRepository, TxAccessTokenRepository, TxRefreshTokenRepository,
    TxAuthorizationCodeRepository,
};
