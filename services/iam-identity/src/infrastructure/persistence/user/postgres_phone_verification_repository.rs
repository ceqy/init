...
mod tests {
    ...
    #[sqlx::test]
    async fn test_save_and_find_phone_verification(pool: PgPool) {
        let repo = PostgresPhoneVerificationRepository::new(pool.clone());
        ...
        assert_eq!(found.unwrap().phone, "+8613800138000");
    }
