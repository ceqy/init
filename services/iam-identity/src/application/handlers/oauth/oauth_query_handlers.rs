...
use crate::application::queries::oauth::{
    GetOAuthClientByIdQuery, ListOAuthClientsResult, ListTenantOAuthClientsQuery,
...
impl QueryHandler<GetOAuthClientByIdQuery> for GetOAuthClientByIdHandler {
    async fn handle(
        &self,
        query: GetOAuthClientByIdQuery,
    ) -> AppResult<Option<OAuthClientQueryResult>> {
        info!(
...
impl QueryHandler<ListTenantOAuthClientsQuery> for ListTenantOAuthClientsHandler {
    async fn handle(
        &self,
        query: ListTenantOAuthClientsQuery,
    ) -> AppResult<ListOAuthClientsResult> {
        info!(
            tenant_id = %query.tenant_id,
            page = query.page,
