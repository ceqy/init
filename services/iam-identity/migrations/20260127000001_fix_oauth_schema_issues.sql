...
ALTER TABLE access_tokens
    ...
    USING CASE
        WHEN pg_typeof(scope) = 'text[]'::regtype
        THEN array_to_string(scope, ' ')
        ELSE scope::TEXT
    END;
...
-- Note: oauth_clients URL columns (logo_url, homepage_url, etc.) were already
-- included in the original migration 20260126080000_create_oauth_clients_table.sql
-- and oauth_clients.id is correctly defined as UUID type.
