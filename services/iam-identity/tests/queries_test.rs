...
use iam_identity::application::queries::oauth::{
    ...
    ValidateOAuthClientResult,
};
use iam_identity::application::queries::user::{
    GetCurrentUserQuery, GetUserByEmailQuery, GetUserByIdQuery, GetUserByUsernameQuery,
    ListUsersQuery, ListUsersResult, UserQueryResult,
};
